...
export const register = async (request: RequestOptions, _: Response, next: NextFunction) => {
...
export const login = async (request: RequestOptions, _: Response, next: NextFunction ) => {
